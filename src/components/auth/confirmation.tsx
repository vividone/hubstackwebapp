...
const ConfirmationMessage = ({ heading, text }: confirmationTexts) => {
  const router = useRouter();

  return (

      <div className="absolute top-0 md:left-[35%] left-0 z-[2] bg-white md:w-[55%] w-full flex flex-col items-center mx-auto min-h-screen py-10 2xl:px-[20%] lg:px-[10%] px-[5%] scroll max-h-screen overflow-y-scroll hide justify-center">
