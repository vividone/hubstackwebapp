...
export const Button = ({
  ...
  const sizes = {
    ...
    long: " text-[18px] py-[20px] md:px-[140px] md:w-fit w-full",
  ...
  const colors = {
    ...
    disabled:opacity-30 `,
    secondary: `bg-[#F9F9F9] hover:border hover:bg-[#F7F7F7] hover:text-[#0D0630] hover:border-[#AEBFC8] active:bg-[#DBE4FF] 
    text-[#104C6A] active:text-[#104C6A] px-[10px]
    disabled:opacity-30 `,
    special: `${
      props.isActive
    ...
    hover:bg-[#E1ECFE] hover:text-[#0443AE] active:bg-[#B0CDFC] active:text-[#003080] disabled:border-[#AEACBA] h-[28px]
