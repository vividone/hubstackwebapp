...
// import nai from "@/assets/icons/nairaIcon";
...
const YourOrderModal = () => {
  return (
    <section className="flex flex-col bg-white w-[45vw] text-black p-10 h-[100vh] overflow-y-scroll">
      <header className="flex justify-between items-center font-medium text-4xl mb-6">
        <h1>Your Order</h1>
        <Image
          width={20}
          height={20}
      ...
      <main>
        <div className="flex flex-col p-4 md:p-8 bg-[#00D7F71A] border border-[#E7E6F2] rounded-md">
          <div className="mb-4 md:mb-6 flex flex-col md:flex-row md:justify-between gap-4 md:gap-8 items-center">
            ...
            <div className="flex bg-[#00D7F7] justify-between items-center p-2 md:p-4 rounded-md h-12 md:h-16 w-40 md:w-48">
        ...
        <section className="bg-[#00D7F7] border border-[#E7E6F2] rounded-md p-4 md:p-8 font-OpensSans">
          <h2 className="font-bold text-[24px]">Bank Details</h2>
          ...
          <div className="flex flex-col gap-[20px] justify-center items-center">
            <div className="flex items-center justify-center gap-[10px]">
              <p className="font-bold font-CabinetGrotesk text-[20px] text-[#3D3066]">
                SHARE DETAILS
              </p>
              <ShareIcon width={17.1} height={21.1} className="text-[#3D3066]"/>
            </div>
            <div className="mt-auto w-full text-[20px]">
              <Button
                size="full"
                variant="secondary"
                className="text-[#3D3066] font-bold bg-[white]"
              >
